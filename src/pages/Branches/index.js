                        ...
                        <div className="section-content">
                            <div className="services-gallery-style3">
                                <div className="row">
                                    {branches.map((branch) => {
                                        return (
                                            <div className="col-lg-4 col-md-6 mb-4" key={branch.city}>
                                                <div className="service-box-style3">
                                                    <div className="service-content">
                                                        <h3 style={{ cursor: 'pointer' }} onClick={() => { navigate(`/branches/packers-movers-${branch.city.toLowerCase()}`) }} className="service-title-large"><span className="service-title-large-number"><div className="c-info-icon fa fa-map-marker"><span></span></div></span>{branch.city}</h3>
                                                        <p>{branch.address}</p>
                                                        <a href={`tel:${branch.phone}`} className="site-button-2"><div className="c-info-icon fa fa-mobile-phone custome-size"><span></span></div> {branch.phone}</a>
                                                        <a style={{ textTransform: "lowercase" }} href={`mailto:${branch.email}`} className="site-button-2"><div className="c-info-icon fa fa-envelope-o"><span></span></div> {branch.email}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        )
